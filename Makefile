...
CFLAGS?=-ggdb -ffunction-sections -O0 -fdata-sections -Wall -fvisibility=hidden
...
ANDROIDSRCS:= $(SRC) $(RAWDRAWANDROIDSRCS) $(NETSRC) $(GUISRC)
...
CFLAGS+=-O0 -DANDROID -DAPPNAME=\"$(APPNAME)\"
...
LDFLAGS += -ljnigraphics -lm -lGLESv3 -lEGL -landroid -llog -fcommon
